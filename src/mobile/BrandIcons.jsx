...
import moveImage from './move-generated.png'
const paths = {
...
export default function BrandIcon({name,size=32,...props}) {
  if(name==='move')return <img src={moveImage} width={size} height={size} alt="" aria-hidden="true" {...props} style={{objectFit:'contain',flexShrink:0,...props.style}}/>
  return <svg viewBox="0 0 40 40" width={size} height={size} fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>{paths[name]||paths.breath}</svg>
}
